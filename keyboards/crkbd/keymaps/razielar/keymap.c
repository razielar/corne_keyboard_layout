...
extern keymap_conyifig_t keymap_config;
...
// _QWERTY: main one; _ADJUST: pressing lower & raise at the same time
enum layers {
  _QWERTY,
  _LOWER,
  _RAISE,
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                         LCTL(KC_LALT), KC_TRNS, KC_SPC,    KC_ENT, RAISE, KC_RALT
                                      //|--------------------------|  |--------------------------|
  ),
...
qk_tap_dance_action_t tap_dance_actions[] = {
  ...
  [TD_ALT] = ACTION_TAP_DANCE_DOUBLE(KC_RALT, KC_LALT),             // Once: right-alt (Alt); tap-dance: left-alt (AltGr)
};
